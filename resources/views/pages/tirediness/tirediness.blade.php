...
<x-app-layout>
    ...
    <x-slot name="header_content">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            ...
            <div class="breadcrumb-item"><a href="{{ route('tirediness.records') }}">Tirediness Records</a></div>
        </div>
    </x-slot>
                            ...
                            <div class="card-header" role="tab" id="headingTree">
                                <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseRec" aria-expanded="true" aria-controls="collapseRec">
                                    <h3 class="mb-0 " style="color:#02b075;">
                                        Year {{ \Carbon\Carbon::now()->format('Y')  }} Tirediness Records <i class="fas fa-angle-down rotate-icon"></i>
                                    </h3>
                                </a>
                            </div>
            ...
            <div class="col-md-3 col-12">
                ...
                <div class="card">
                    <div class="card-header" style="display:flex;justify-content:space-around;">
                        <h4>Add Tirediness Record</h4>
                        <a data-toggle="modal" data-target="#uploadTirediness" class="btn btn-info" style="border-radius:50px;"><i class="fas fa-plus"></i> Upload</a>
                    </div>
                
                    <form action="{{ url('tirediness') }}" method="post"  class="needs-validation" novalidate="">
                        @method('POST')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <input type="text" name="minutes" id="minutes" class="form-control"  required="">
                                    <label>Minutes</label>
                                    <div class="invalid-feedback">
                                            Please fill in the Minutes
                                    </div>
                                </div>
